...
public class Event implements Recommendable{
    ...
    @java.beans.ConstructorProperties({"id", "title", "date", "coordinate", "profile", "description", "address"})
    Event(String id, String title, Long date, Coordinate coordinate, Map<String, Integer> profile, String description, String address) {
        this.id = id;
        this.title = title;
        this.date = date;
        ...
        location[0] = coordinate.getLatitude();
        location[1] = coordinate.getLongitude();
    }
    ...
    public static class EventBuilder {
        ...
        public Event build() {
            return new Event(id, title, date, coordinate, profile, description, address);
        }
